...
<section class="hero my-20 font-inter px-6 md:p-0 mx-auto">  
  <div class="title md:w-4/5 md:mx-5">
    ...
    <a href="#" class=" mt-5 mb-14 bg-blue-500 inline-block text-white text-sm py-2 px-3 sm:text-md sm:py-3 sm:px-5 md:text-sm  md:py-2 md:px-3 rounded-full lg:py-2 lg:px-3 lg:text-lg">Lorem, ipsum dolor.</a>
